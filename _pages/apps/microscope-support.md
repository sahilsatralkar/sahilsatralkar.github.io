...
- your iPhone model;
- your iOS version;
- the step where the issue occurred; and
- a screenshot or screen recording, if it does not contain sensitive material.

Do not email microscope captures or other sensitive content unless it is necessary for your support request.

## Requirements

- An iPhone running iOS 26 or later
- An optical microscope
- A compatible iPhone eyepiece adapter
- Access to the rear 1× Main camera
...
Manage subscriptions in your Apple Account under **Settings > [your name] > Subscriptions**. Apple provides current instructions at [Manage or cancel subscriptions](https://support.apple.com/HT202039).

### How do I request a refund?

Purchases are billed and managed by Apple. Refund eligibility and requests are handled at [reportaproblem.apple.com](https://reportaproblem.apple.com/).
