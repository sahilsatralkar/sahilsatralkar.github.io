# Privacy Policy for Microscope

**Effective date:** July 25, 2026  
**Canonical URL:** https://sahilsatralkar.com/apps/microscope/privacy
...
Microphone access is optional and is requested only if you enable audio for video recording. Audio is recorded into the video on your iPhone and is not uploaded to us.
...
If you email us for support or a privacy question, we receive the email address, message, and attachments you choose to provide. We use that information only to respond, troubleshoot, protect the app and its users, or meet legal obligations. We retain support correspondence only for as long as reasonably needed for those purposes.

Do not send microscope captures or other sensitive content unless it is necessary for your request.
...
- manage Camera, Photos, and Microphone permissions in iPhone Settings;
- leave video audio disabled;
- delete saved captures in Photos;
- delete the app to remove app-local settings and temporary data; and
- contact us with a privacy question.

Because we do not operate user accounts or collect personal data through the app, we do not hold an account profile or cloud media library for you to access or delete.

## Children's privacy

We do not knowingly seek personal data from children. If you believe a child has sent personal information to our support address, contact us so that we can delete it where appropriate.

## Changes to this policy

We may update this policy if the app's practices or legal requirements change. The revised policy will be posted at this URL with a new effective date.

## Contact

For privacy questions, email [priya.satralkar8@gmail.com](mailto:priya.satralkar8@gmail.com).
